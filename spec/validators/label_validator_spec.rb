...
describe DogBiscuits::LabelValidator do
  ...
  it 'does not save without a preflabel' do
    expect(authority.save).to be_falsey
  end

  it 'does not save without a preflabel or name part' do
    expect(person.save).to be_falsey
  end

  it 'saves without a preflabel or name' do
