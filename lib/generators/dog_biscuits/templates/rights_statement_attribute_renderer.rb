...
#  module Renderers
    ...
    class RightsStatementAttributeRenderer < Hyrax::Renderers::AttributeRenderer
      private

      ##
      # Special treatment for rights statement.  A URL from the Hyrax gem's config/hyrax.rb is stored in the descMetadata of the
