...
This generator .
  ...
  def date_range
    if DogBiscuits.config.date_range == true
      ...
      catalog = "    config.add_facet_field 'date_range_sim', label: 'Date Range', range: {\n"
      catalog += "                         num_segments: 6,\n"
      catalog += "                         assumed_boundaries: [1100, Time.now.year + 2],\n"
      catalog += "                         segments: false,\n"
      catalog += "                         maxlength: 4\n"
      catalog += "                         }\n"
